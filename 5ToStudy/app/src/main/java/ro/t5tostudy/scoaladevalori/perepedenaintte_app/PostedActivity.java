...
public class PostedActivity extends AppCompatActivity {
            ...
            for (TestPackage testPackage : LoginActivity.userList.get(UserSignInActivity.userIndex).postedTestPackage) {
                ...
                mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(PostedActivity.this, ViewPostedTestActivity.class);
                        Bundle b=new Bundle();
    ...
    public void openSearchPostedActivity(View v) {
        startActivityForResult(new Intent(PostedActivity.this, SearchPostedActivity.class), 1);
    }
