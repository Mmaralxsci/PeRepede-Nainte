...
public class SearchPostedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileBtn = findViewById(R.id.back_search_posted_btn);
        mSearchBtn = findViewById(R.id.search_search_posted_btn);
        mTesttezaBtn = findViewById(R.id.testteza_search_posted_tgl);
    ...
    public void openListPostedActivity (View v) {

        mTesttezaBtn = findViewById(R.id.testteza_search_posted_tgl);

        final SearchParametersPackage parameters = new SearchParametersPackage();
        parameters.subject = mSubject.getText().toString();mTesttezaBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        Intent intentList = new Intent(SearchPostedActivity.this, ListPostedActivity.class);
