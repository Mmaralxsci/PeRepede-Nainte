...
public class ListPostedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_posted);

        mSearchBtn = findViewById(R.id.search_list_posted_btn);
        mListView = findViewById(R.id.list_posted_list_view);
        ...
        if(LoginActivity.userList.get(UserSignInActivity.userIndex).postedTestPackage!= null) {
            for (TestPackage testPackage : LoginActivity.userList.get(UserSignInActivity.userIndex).postedTestPackage) {
                if(testPackage.subject.equals(bundle.getString("subject"))&&
                    ...
                    mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(ListPostedActivity.this, ViewPostedTestActivity.class);
                            Bundle b=new Bundle();
    ...
    public void openSearchPostedActivity(View v) {
        setResult(RESULT_OK);
        finish();
    }
}
